// 7. As maçãs custam R$ 0,30 se forem compradas menos 
// do que uma dúzia, e R$ 0,25 se forem compradas pelo
// menos doze. Escreva um algoritmo que leia o número de maçãs
